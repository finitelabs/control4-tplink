...
3.  Use the "Search" tab to find the "TP-Link Kasa Power Strip" driver and add
    it to your project (one instance per physical device).
...
##### Log Level \[ Fatal \| Error \| Warning \| _**Info**_ \| Debug \| Trace \| Ultra \]

Sets the logging level. Default is `Info`.

##### Log Mode \[ _**Off**_ \| Print \| Log \| Print and Log \]
